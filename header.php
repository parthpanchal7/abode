        ...
        <div class="container">
            <div class="main-header-wrap">
                ...
                <div class="main-menu-wrap">
                    <ul class="main-menu">
                    <li class="has-submenu mega-menu-wrapper"><a href="#">About Abode Enterprise</a>
                            <ul class="submenu mega-menu">
                                <div class="mega-menu-wrap">
                                    <div class="single-menu-wrap" data-menu-title="about-abode">
                                        <div class="left-part">
                                            <div class="left-menu-wrap">
                                                <div class="single-menu" data-menu-title="about-abode">
                                                    <a href="#">
                                                        <div class="single-menu-item">
                                                            ...
                                                            <strong>About Abode Enterprise</strong>
                                                        </div>
                                                    </a>
                                                </div>
